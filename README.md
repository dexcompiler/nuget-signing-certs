...
- CI validates restore/build/test and packaging for the library and CLI.
- Tag pushes (`v*.*.*`) run publish workflow:
  - package/push library to NuGet.org
  - create GitHub release
  - upload NativeAOT CLI binaries as release assets.
